...
export class ConfigService {
  ...
  private validateInput(envConfig): EnvConfig {
    const envVarsSchema: Joi.ObjectSchema = Joi.object({
      ...
      TYPEORM_PASSWORD: Joi.string().default('udapeople123'),
      TYPEORM_DATABASE: Joi.string().default('glee'),
      TYPEORM_HOST: Joi.string().default('udapeople-app.cxdhd0mkpcug.us-east-1.rds.amazonaws.com'),
